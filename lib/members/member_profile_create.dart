...
class MemberProfileCreate extends StatefulWidget {
  const MemberProfileCreate({super.key});

  @override
  State<MemberProfileCreate> createState() => _MemberProfileCreateState();
}

enum Gender { male, female }

class _MemberProfileCreateState extends State<MemberProfileCreate> {
